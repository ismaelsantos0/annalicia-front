    ...
    <div className="fixed bottom-6 right-6 z-50">
      {!open && (
        <button
          ...
          className="group relative flex h-16 w-16 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-xl transition-transform hover:scale-110 hover:bg-primary/90"
        >
      ...
      {open && (
        <div className="absolute bottom-0 right-0 w-[calc(100vw-3rem)] sm:w-80 overflow-hidden rounded-3xl bg-card shadow-2xl ring-1 ring-black/5 animate-in slide-in-from-bottom-8">
          <div className="bg-gradient-to-r from-primary to-accent p-6 text-primary-foreground relative">
            ...
            <Sparkles className="h-8 w-8 mb-2 text-primary-foreground/80" />
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-3">
                  <input
                    ...
                    className="w-full rounded-xl border border-border p-3 text-sm outline-none focus:border-primary bg-background text-foreground"
                  />
                  <input
                    type="tel"
                    required
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary p-3 font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-70"
                >
